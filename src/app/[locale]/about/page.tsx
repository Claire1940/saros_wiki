...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'About Saros Wiki - Your Ultimate PS5 Game Resource',
    description: 'Learn about Saros Wiki, a community-driven resource hub providing comprehensive guides, trailer updates, lore analysis, and strategies for the Saros PS5 game.',
    keywords: [
      'about Saros Wiki',
      'Saros community',
      'PS5 game wiki',
    ...
    openGraph: {
      ...
      siteName: 'Saros Wiki',
      title: 'About Saros Wiki',
      description: 'Learn about our mission to provide the best Saros game resources and guides.',
      images: [
        {
    ...
    twitter: {
      ...
      title: 'About Saros Wiki',
      description: 'Learn about our mission to provide the best Saros game resources.',
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Your community-driven resource center for Saros
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Welcome to Saros Wiki</h2>
            <p>
              Saros Wiki is an <strong>unofficial, fan-made resource website</strong> dedicated to helping players
              master the PS5 game "Saros". We are a community-driven platform that provides comprehensive guides,
            ...
            <p>
              ...
              Saros Wiki is here to support you every step of the way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower Saros players with accurate, up-to-date information
            ...
            <h2>Our Vision</h2>
            <p>
              We envision Saros Wiki as the <strong>go-to destination</strong> for every Saros player seeking
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Saros Wiki is built <strong>by the community, for the community</strong>. We welcome contributions,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Saros Wiki is maintained by a dedicated team of passionate gamers and developers who love
              Saros as much as you do. We're players first, constantly testing strategies, exploring game
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of Saros mechanics and strategies</li>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-yellow-400/90">
              <strong>Saros Wiki is an unofficial fan-made website.</strong> We are NOT affiliated with,
              endorsed by, or associated with the developers of Saros or any official entities.
            </p>
            <p>
            ...
            <p>
              Saros Wiki is a non-profit, community resource created by fans, for fans.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@saros.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@saros.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@saros.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@saros.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@saros.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@saros.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@saros.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@saros.wiki
                </a>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest guides, tips, and Saros news.
