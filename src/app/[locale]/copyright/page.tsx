...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Saros Wiki',
    description: 'Copyright and intellectual property information for Saros Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    keywords: [
      'copyright notice',
      'Saros Wiki copyright',
      'DMCA policy',
    ...
    openGraph: {
      ...
      siteName: 'Saros Wiki',
      title: 'Copyright Notice - Saros Wiki',
      description: 'Copyright and intellectual property information for Saros Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Saros Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Saros Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Saros Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>PlayStation</strong> - Platform and related trademarks owned by Sony Interactive Entertainment</li>
              <li><strong>Housemarque</strong> - Developer of the Saros game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Saros</strong> - Trademark of the game developers</li>
              <li><strong>Saros Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
            ...
            <p>
              ...
              Saros Wiki<br />
              Email: <a href="mailto:dmca@saros.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@saros.wiki</a>
            </p>
            <p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@saros.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@saros.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@saros.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@saros.wiki</a>
            </p>
            <p>
