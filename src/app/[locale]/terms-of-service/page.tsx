...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Saros Wiki",
    description: "Read the Terms of Service for Saros Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our PS5 game resource hub.",
    keywords: [
      'terms of service',
      "Saros Wiki terms",
      'user agreement',
    ...
    openGraph: {
      ...
      siteName: "Saros Wiki",
      title: "Terms of Service - Saros Wiki",
      description: "Terms and conditions for using Saros Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Saros Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Saros Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Saros Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Saros Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the PS5 game "Saros". Our services include, but are not limited to:
            </p>
            <ul>
            ...
            <p>
              <strong>Important:</strong> Saros Wiki is NOT affiliated with, endorsed by, or associated with
              Sony Interactive Entertainment (PlayStation), Housemarque, or the official developers of Saros.
              We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Saros Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Sony Interactive Entertainment (PlayStation), Housemarque, and/or the
              developers of Saros. We use such content under fair use principles for informational and educational
              purposes only.
            </p>
            ...
            <ul>
              ...
              <li><strong>Feature Availability:</strong> Platform features, release windows, and updates may change without notice.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, SAROS WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including PlayStation, Discord, and social media platforms,
            ...
            <p>
              ...
              you and Saros Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@saros.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@saros.wiki</a>
            </p>
            <p>
